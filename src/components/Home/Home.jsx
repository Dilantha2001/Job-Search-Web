...
const popularLists = ["Software Engineer", "Accountant", "HR Executive", "Marketing Specialist"];
...
const Home = () => {
  ...
  const locations = ["Colombo", "Kandy", "Galle", "Jaffna", "Kurunegala"];
    ...
    <section className="bg-[#F8F8FD] py-10 pb-0 lg:pt-5 lg:py-0 relative z-10 overflow-x-hidden">
      <div className="container relative z-10 w-full overflow-hidden">
        <div className="grid items-center w-full h-full grid-cols-1 gap-10 lg:grid-cols-2">
          {/* Left Section */}
          <RevealOnScroll className="lg:self-start lg:pt-28">
          ...
          {/* Right Section */}
          <RevealOnScroll className="flex-shrink-0 w-full" delay={150}>
            <div className="relative">
              <img
                src={HeroImage}
